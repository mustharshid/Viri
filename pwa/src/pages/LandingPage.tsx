    ...
    <div className="min-h-screen bg-[#09090b] text-[#f8fafc] overflow-hidden relative font-sans">
      ...
      <nav className="relative z-10 w-full flex justify-between items-center px-8 py-6 max-w-7xl mx-auto backdrop-blur-sm">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#10b981] to-[#047857] flex items-center justify-center font-bold text-white shadow-lg shadow-[#10b981]/30">
            V
          </div>
          <span className="text-2xl font-heading font-bold tracking-tight">Viri<span className="text-[#10b981]">.</span></span>
        </div>
      ...
      <footer className="relative z-10 border-t border-white/10 py-12 bg-black text-center text-gray-500">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded bg-[#10b981] flex items-center justify-center font-bold text-white text-xs">V</div>
            <span className="font-heading font-bold text-gray-300">Viri.</span>
          </div>
