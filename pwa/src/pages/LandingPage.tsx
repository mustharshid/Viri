  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-[#f8fafc] overflow-hidden relative font-sans">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-32 flex flex-col items-center text-center">
        ...
        <img src="/logo_dv_en.png" alt="Viri logo" className="h-28 md:h-36 object-contain mb-8 animate-fade-in" style={{ animationDelay: '0.05s' }} />
      ...
      <footer className="relative z-10 border-t border-white/10 py-12 bg-black text-center text-gray-500">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <img src="/logo_en.png" alt="Viri Logo" className="h-6 object-contain" />
          </div>
